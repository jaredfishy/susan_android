...
public class LightOffTask extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... string) {
        ...
        String response = responseProcessor.getString(service.turnOff());

        System.out.println("Light Off response: " + response);
        return response;
    }
}
